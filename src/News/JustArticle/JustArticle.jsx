...
const JustArticle = () => {
    ...
    const journals = articles.filter((journal) => journal.category === 'Article')
    return (
        <div>
            ...
            <div className='py-2 lg:px-20 md:px-16 sm:px-12 px-12'>
                <div className='py-6'>
                    <h2 className='text-2xl font-bold  title-text text-[#262626]'>Read Just Article</h2>
                ...
                <div className='flex flex-wrap gap-6'>
                    ...
                    <div className='lg:w-3/4'>
                        ...
                        <div className='space-y-3'>
                                  {
                                    journals.slice(0,4).map((article,index) =><NewsCard key={article.index}
                                    article={article}
                                    >
                                   ...
                                   <div className='py-8'>
                                   <button  className="px-4 py-2 border bg-[#10147E] hover:bg-[#006DB4] duration-300 text-white flex items-center">More item</button>
                                   </div>
                            </div>
                    </div>
